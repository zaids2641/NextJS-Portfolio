import ProfileImage from "@/assets/profile_image/profile_2.png";
...
function IntroImage() {
  ...
  return (
    <div className="relative w-full h-full bg-[var(--dark)] overflow-hidden">
      {/* Centering container */}
      <div className="flex items-center justify-center w-full h-full relative">
        
        {/* Blur backgrounds */}
        <div
          className="absolute bg-[var(--accent-teal)] rounded-full blur-3xl translate-x-32 -translate-y-20"
          style={{
        ...
        <div
          className="absolute bg-[var(--accent-teal)]/30 rounded-full blur-3xl -translate-x-38 translate-y-20"
          style={{
            width: "clamp(12rem, 30vw, 24rem)",
            height: "clamp(12rem, 30vw, 24rem)",
          }}
      ...
      {/* Dark overlay */}
      {/* <div
        className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-full h-full bg-no-repeat bg-cover"
        style={{
  ...
  />
      ...
      <div className="absolute top-1/2 right-10 flex flex-col justify-between items-center h-1/2 z-30">
        <div>
      ...
      <div className="w-full absolute top-100 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 block_visible">
        <IntroText />
      </div>
    </div>
  );
